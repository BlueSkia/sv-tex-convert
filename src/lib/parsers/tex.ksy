# Original by kartoffels123
# https://github.com/kartoffels123/ffxiv-tex-converter/blob/master/src/parsers/tex.ksy
# Additions based on Lumina (just a few more texture formats)
